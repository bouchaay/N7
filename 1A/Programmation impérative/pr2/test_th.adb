...
procedure Test_TH is
	...
	package TH_String_Integer is
		new TH (T_Cle => Unbounded_String, T_Donnee => Integer, CAPACITE => Capacite ,traiter_cle_hachage => fonction_hachage);
	...
	begin
		...
		for I in 1..Nb_Cles loop
			Enregistrer (Annuaire, Donnees (I), Cles (I));
	...
	procedure Tester_Remplacer_Un_Element is
		...
		begin
			...
			enregistrer (Annuaire, Nouveau, Cles (Indice));
