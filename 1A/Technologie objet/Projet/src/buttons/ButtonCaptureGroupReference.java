 ...
 */
public class ButtonCaptureGroupReference extends ButtonClickAbstract implements ActionListener {

    /** Block associé au bouton. */
    private BlockCaptureGroupReference block;
     ...
     */
    public ButtonCaptureGroupReference(BlockCaptureGroupReference block, JTextPane textField) {
     ...
     */
    public BlockCaptureGroupReference getBlock() {
        return block;
    }
     ...
     */
    public void setBlock(BlockCaptureGroupReference block) {
        this.block = block;
    }
        ...
        choixGroup.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
                try {
                    ...
                    BlockCaptureGroupReference newBlock = new BlockCaptureGroupReference(block.getId(), false, choixGroup.getChoix());
     ...
     * @return Block associé au bouton
     */
    public static BlockCaptureGroupReference returnButtonType () {
        return new BlockCaptureGroupReference("Id-4", false, "GROUP_NAME");
    }
}
