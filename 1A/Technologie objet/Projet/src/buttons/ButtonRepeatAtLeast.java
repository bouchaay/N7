...
/** Classe action pour les boutons de type répéter au moins.
...
public class ButtonRepeatAtLeast extends ButtonClickAbstract implements ActionListener {
     ...
     */
    public ButtonRepeatAtLeast(BlockRepeatAtLeast block, JTextPane textField) {
     ...
     */
    public void setBlock(BlockRepeatAtLeast block) {
        this.block = block;
    }
        ...
        AskRegex choixGroup = new AskRegex();
            ...
            choixGroup.addWindowListener(new WindowAdapter() {
                ...
                public void windowClosed(WindowEvent e) {
                    ...
                    try {
                        BlockRepeatAtLeast newBlock = new BlockRepeatAtLeast(block.getId(), false, Integer.parseInt(choixGroup.getChoix()), false);
    ...
    public static BlockRepeatAtLeast returnButtonType () {
        return new BlockRepeatAtLeast("Id-17", false, 5, false);
    }
