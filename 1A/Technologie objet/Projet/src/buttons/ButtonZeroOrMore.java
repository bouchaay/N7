...
/** Classe action pour les boutons de type zero ou plus.
 * prend en paramètre un block et un champ de texte.
 */
public class ButtonZeroOrMore extends ButtonClickAbstract implements ActionListener {

    /** Block associé au bouton. */
    private BlockZeroOrMore block;
     ...
     */
    public ButtonZeroOrMore(BlockZeroOrMore block, JTextPane textField) {
     ...
     */
    public BlockZeroOrMore getBlock() {
        return block;
    }
     ...
     */
    public void setBlock(BlockZeroOrMore block) {
        this.block = block;
    }
     ...
     * @return Block associé au bouton
     */
    public static BlockZeroOrMore returnButtonType () {
        return new BlockZeroOrMore("Id-22", false, false);
    }
}
