...
/** Classe action pour les boutons de type n'importe quel caractère.
 * prend en paramètre un block et un champ de texte.
 */
public class ButtonAnyCharacter extends ButtonClickAbstract implements ActionListener {

    /** Block associé au bouton */
    private BlockAnyCharacter block;
     ...
     */
    public ButtonAnyCharacter(BlockAnyCharacter block, JTextPane textField) {
     ...
     */
    public BlockAnyCharacter getBlock() {
        return block;
    }
     ...
     */
    public void setBlock(BlockAnyCharacter block) {
        this.block = block;
    }
     ...
     * @return Block associé au bouton
     */
    public static BlockAnyCharacter returnButtonType () {
        return new BlockAnyCharacter("Id-2", false);
    }
}
