...
/** Classe action pour les boutons de type expression brute.
 * prend en paramètre un block et un champ de texte.
 */
public class ButtonRawRegex extends ButtonClickAbstract implements ActionListener {

    /** Block associé au bouton. */
    private BlockRawRegex block;
     ...
     */
    public ButtonRawRegex(BlockRawRegex block, JTextPane textField) {
     ...
     */
    public void setBlock(BlockRawRegex block) {
        this.block = block;
    }
    	...
    	AskRegex choixGroup = new AskRegex();
            ...
            choixGroup.addWindowListener(new WindowAdapter() {
                ...
                public void windowClosed(WindowEvent e) {
                    ...
                    try {
                        BlockRawRegex newBlock = new BlockRawRegex(block.getId(), false, choixGroup.getChoix());
     ...
     * @return Block associé au bouton
     */
    public static BlockRawRegex returnButtonType () {
        return new BlockRawRegex("Id-15", false, "VOTRE_EXPRESSION");
    }
