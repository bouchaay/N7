...
nx.draw(Gl20w, with_labels=True, arrows=False, pos=nx.spring_layout(Gl20w))
# Graphes low 40km (weighted)
plt.figure(figsize=(10, 10))
plt.title('Graphe low 40km (weighted)')
nx.draw(Gl40w, with_labels=True, arrows=False, pos=nx.spring_layout(Gl40w))
# Graphes low 60km (weighted)
plt.figure(figsize=(10, 10))
plt.title('Graphe low 60km (weighted)')
nx.draw(Gl60w, with_labels=True, arrows=False, pos=nx.spring_layout(Gl60w))
...
nx.draw(Gh20w, with_labels=True, arrows=False, pos=nx.spring_layout(Gh20w))
# Graphes high 40km (weighted)
plt.figure(figsize=(10, 10))
plt.title('Graphe high 40km (weighted)')
nx.draw(Gh40w, with_labels=True, arrows=False, pos=nx.spring_layout(Gh40w))
# Graphes high 60km (weighted)
plt.figure(figsize=(10, 10))
plt.title('Graphe high 60km (weighted)')
nx.draw(Gh60w, with_labels=True, arrows=False, pos=nx.spring_layout(Gh60w))
