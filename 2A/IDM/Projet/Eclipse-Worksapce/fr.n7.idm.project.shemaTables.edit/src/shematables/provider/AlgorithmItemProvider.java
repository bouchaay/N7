...
/**
 * This is the item provider adapter for a {@link shematables.Algorithm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlgorithmItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ShematablesPackage.Literals.ALGORITHM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Algorithm_path_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Algorithm_path_feature", "_UI_Algorithm_type"),
				 ShematablesPackage.Literals.ALGORITHM__PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShematablesPackage.Literals.ALGORITHM__OUTPUT);
			childrenFeatures.add(ShematablesPackage.Literals.ALGORITHM__INPUT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ShematablesPackage.Literals.ALGORITHM__OUTPUT,
				 ShematablesFactory.eINSTANCE.createOutput()));

		newChildDescriptors.add
			(createChildParameter
				(ShematablesPackage.Literals.ALGORITHM__INPUT,
				 ShematablesFactory.eINSTANCE.createInput()));
	}
