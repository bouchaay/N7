...
/**
 * This is the item provider adapter for a {@link shematables.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_filePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_filePath_feature", "_UI_Constraint_type"),
				 ShematablesPackage.Literals.CONSTRAINT__FILE_PATH,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Constraint)object).getFilePath();
